...
/*   Updated: 2025/04/10 16:26:20 by chrlomba         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			process_variable(t_token **token,
				char *str, int string_position, t_bau_args *miao_diobon);
...
** Returns a newly allocated string
 containing the value (i.e., the part after '='),
...
*/
int			env_replace_entry(t_env_list *env,
				const char *key, const char *full_entry);
...
** check_var():
** Processes an input
string to extract a variable and update the environment list.
** It uses token information
 to determine the key and then either adds or replaces
