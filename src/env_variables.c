...
** Executes a command in a child procesits stdout into a pipe.
...
// /*
// ** process_variable()
// ** Processes a variable found in th** value from yo
// ** The function now works with a t
// {
//     char *variable;
//     int   len = 0;
...
//         char *command_output = execute_and_captu
//         free(command);
//         if (!command_output)
//             return (free_tokens_line(str, *to
